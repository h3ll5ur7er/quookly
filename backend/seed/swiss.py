...
The workbook is downloaded from naehrwertdaten.ch. Its terms permit commercial use
"subject to acknowledgment of the source", and opendata.swiss records the dataset as
"Open use. Must provide the source." — which is why every profile carries its credit and
why FR-20 exists (ADR-007).
...
WORKBOOK = Path("/tmp/swiss_food_composition_database.xlsx")
